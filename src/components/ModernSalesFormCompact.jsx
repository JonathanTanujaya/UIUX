    ...
    <div className="min-h-full bg-gray-50">
      <div className="max-w-full mx-auto">
        ...
        <div className="bg-white shadow-sm border">
          {/* Header Form - Compact */}
          <div className="p-3 border-l-4 border-green-500 border-b border-gray-200">
            {/* Single Row: Tanggal, Customer, Sales, Tipe */}
          ...
          {/* Main Content - Table dan Summary (dalam satu container) */}
          <div className="grid grid-cols-1 lg:grid-cols-4">
            ...
            <div className="p-3 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <button 
                  onClick={addItem}
                  className="px-2 py-1.5 bg-green-600 text-white rounded-md hover:bg-green-700 text-xs flex items-center space-x-1"
                >
              ...
              <table className="w-full text-xs">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-2 py-1.5 text-left text-xs font-medium text-gray-500 uppercase" style={{ minWidth: '120px' }}>Kode Barang</th>
                    ...
                    <th className="px-2 py-1.5 text-left text-xs font-medium text-gray-500 uppercase" style={{ width: '70px' }}>Disc1%</th>
                    <th className="px-2 py-1.5 text-left text-xs font-medium text-gray-500 uppercase" style={{ width: '90px' }}>Jenis Item</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {formData.items.map((item, index) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-2 py-1.5 text-xs">
                        <div className="flex space-x-1">
                          ...
                          <button 
                            ...
                            className="px-1 py-1 bg-green-600 text-white rounded hover:bg-green-700 text-xs flex-shrink-0"
                          >
                            <Search className="w-3 h-3" />
                          </button>
                        </div>
                      </td>
                      <td className="px-2 py-1.5 text-xs text-gray-900 truncate" style={{ maxWidth: '180px' }}>{item.namaBarang}</td>
                      <td className="px-2 py-1.5 text-xs text-gray-900 text-right">{formatCurrency(item.harga)}</td>
                      <td className="px-2 py-1.5 text-xs">
                        <input
                          type="number"
                          value={item.qty}
                      ...
                      <td className="px-2 py-1.5 text-xs text-green-600 text-right font-medium">{formatCurrency(item.subtotal)}</td>
            ...
            <div className="lg:col-span-1 p-3">
              ...
              <div className="mb-3 p-2 bg-green-50 border border-green-200 rounded-lg">
                ...
                <div className="text-xs text-green-600">
                  <div className="truncate">{customers.find(c => c.kode === formData.kodeCustomer)?.nama || 'Belum dipilih'}</div>
              ...
              <div className="space-y-2 mb-3">
                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-1">Total Discount Semua</label>
                  <input
                    type="number"
              ...
              <div className="border-t pt-3 space-y-1.5">
                ...
                <div className="border-t pt-1.5">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-green-600 text-sm">{formatCurrency(totals.grandTotal)}</span>
                  </div>
                </div>
              </div>
