      ...
      <div className="w-full mx-auto flex-1 flex flex-col">
        ...
        <div className="bg-white shadow-sm border flex-1 flex flex-col">
          ...
          <div className="flex flex-1">
                          ...
                          {searchSuggestions.map((item, index) => (
                            ...
                            >
                              ...
                              <div className="text-xs text-gray-500 mt-1">
                                {item.satuan.toUpperCase()} • {item.kode_kategori}
                              </div>
                            </div>
                          ))}
                        </div>
                    ...
                    {formData.items.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-2 py-1.5 text-xs text-right">
                          <span className="font-medium text-gray-900">Rp {formatCurrency(item.harga)}</span>
                        </td>
                        <td className="px-2 py-1.5 text-xs">
                          <input
                            type="number"
                        ...
                        <td className="px-2 py-1.5 text-xs font-medium text-gray-900 text-right">
                          Rp {formatCurrency(calculateItemSubtotal(item))}
                        </td>
                        <td className="px-2 py-1.5 text-xs">
                          <button
            ...
            {/* Sticky Summary Panel - Fixed width */}
            <div className="w-80 p-3 flex flex-col h-full bg-gray-50">
